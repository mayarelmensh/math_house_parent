...
class NotificationScreen extends StatelessWidget {
        ...
        body: BlocBuilder<NotificationCubit, NotificationState>(
          builder: (context, state) {
            if (state is NotificationInitial) {
              ...
              return _buildNotificationContent(context, state.response);
  ...
  Widget _buildNotificationContent(BuildContext context, NotificationResponse response) {
              ...
              itemBuilder: (context, index) {
                ...
                return Card(
                  ...
                  child: ListTile(
                    ...
                    leading: Icon(
                      Icons.notifications,
                      color: notification.isRead == true ? AppColors.gray : AppColors.primary,
                      size: 40,
                    ),
                    title: Text(
                      ...
                      style: TextStyle(
                        fontSize: 16,
                        fontWeight: FontWeight.w600,
                        color: notification.isRead == true ? AppColors.gray : AppColors.darkGray,
                      ),
                    ),
                    subtitle: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
